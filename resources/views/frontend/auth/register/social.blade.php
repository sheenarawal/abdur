...
@section('frontend_content')
    ...
    <div class="col-md-8 mx-auto p-5 text-justify bg-light">
        ...
        <form>
            ...
            <div class="mt-3">
                <span class="info">Fundrise uses bank-level security for your protection. Your information is encrypted
                    with an AES bit symmetric key, the same standard used by the largest commercial banks.
                </span>
            </div>
            <div class="form-group">
                <label for="social_link_no">SOCIAL SECURITY NUMBER</label><br>
                <input type="text" class="form-control" id="social_link_no" aria-describedby="emailHelp"
                       name="social_link_no">
...
@stop
@stack('styles')
<link rel="stylesheet" href="{{asset('frontend/css/source.css.css')}}">
