        ...
        <h1 class="mb-3"><i>Thanks, {{$name}}</i></h1>
		   ...
		   @csrf	
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="address1">
				  <span class="info"> This should be the address used for tax purposes.</span>
                </div>
                @error('address1')
            ...
            @enderror
				<div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="address2">
...
@stop
@stack('styles')
<link rel="stylesheet" href="{{asset('frontend/css/address.css')}}">
