    ...
    <div class="col-md-8 mx-auto p-5 text-justify bg-light">
        ...
        <form method="post">
            ...
            <div class="col d-flex">
                ...
                <span class="text-danger form-text">{{$message}}</span>
                @enderror
                <input type="checkbox" class="mt-2" name="agree" id="agree">
                <label class="form-label mt-0 px-3" for="agree">
                    I have reviewed and agree to the Terms of Service , Privacy Policy , Fundrise Advisors Form ADV
                    Part II, Fundrise Advisors Form CRS , and Fundrise Advisors Client Agreement.
                </label>
            </div>
            <br>
